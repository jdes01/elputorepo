...
def test_handle_success(handler, mock_repository):
    ...
    events = [
        Event.create(id=EventId.generate(), name=EventName("Event Name aaa"), capacity=EventCapacity(50)),
        Event.create(id=EventId.generate(), name=EventName("Event Name bbb"), capacity=EventCapacity(150)),
    ]
